...
mod deep_dive_tests {
    ...
    fn test_garch_volatility_forecasting() {
        ...
        // Volatility should mean-revert over time
        assert!(twenty_day_vol > one_day_vol * 0.8 && twenty_day_vol < one_day_vol * 1.2);
    ...
    fn test_market_analytics_calculations() {
        ...
        assert!(all_features.len() >= 19, "Should extract at least 19 ML features");
