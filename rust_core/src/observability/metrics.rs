...
pub fn init_metrics() {
    ...
    REGISTRY.register(Box::new(RISK_CHECK_LATENCY.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(ORDER_INTERNAL_LATENCY.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(CB_STATE.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(CB_TRIP_TOTAL.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(CB_FAILURE_RATE.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(CB_CHECK_LATENCY.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(OPERATIONS_TOTAL.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(ORDERS_PROCESSED.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(ORDERS_RECEIVED.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(MEMORY_POOL_AVAILABLE.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(MEMORY_POOL_TOTAL.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(ALLOCATION_LATENCY.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(MAX_DRAWDOWN_CURRENT.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(MAX_POSITION_SIZE_RATIO.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(PORTFOLIO_CORRELATION.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(RISK_CHECK_PASS.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(RISK_CHECK_FAIL.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(ORDER_QUEUE_DEPTH.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(ORDERS_BY_TYPE.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(ORDERS_SUCCESS.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(ORDERS_FAILED.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(EXCHANGE_API_LATENCY.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(MARKET_DATA_LAST_UPDATE.clone())).expect("metric registration failed");
    REGISTRY.register(Box::new(ORDER_BOOK_DEPTH.clone())).expect("metric registration failed");
}
