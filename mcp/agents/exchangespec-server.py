#!/usr/bin/env python3
"""
MCP Server for drew (Exchange Specialist)
...
class ExchangespecAgent:
    """Exchange Specialist Agent - drew"""
    
    def __init__(self):
        self.name = "drew"
        self.role = "Exchange Specialist"
...
async def main():
    ...
    agent = ExchangespecAgent()
    server = Server("exchangespec")
